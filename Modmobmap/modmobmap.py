...
SRSRAN_PATH = "thirdparty/srsRAN/" # thirdparty project
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--device', dest='dname', required=False, default=None,
    ...
    if args.module == "xgoldmod":
        ...
        phoneinteract = True
    elif args.module == "srsran_pss" or args.module == "srsran_npss":
        kb.config['SRSRANTOOLS_PATH'] = SRSRAN_PATH + "build/lib/examples/"
        kb.config['file'] = "celllog.fifo"
	kb.config['device_name'] = args.dname
	if args.dname is not None:
            print ("Starting to scan with device name", args.dname)
        if args.file is not None:
            kb.config['file'] = args.file
